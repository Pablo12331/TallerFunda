...
static const yytype_int16 yyrline[] =
{
     ...
     130,   134,   138,   142,   146,   155,   165,   169,   178,   187,
     202,   219,   229,   237,   245,   255,   256,   277,   279,   284,
     286,   288,   294,   298,   306,   318,   319,   324,   337,   373,
     374,   379,   388,   389,   393,   394,   399,   400,   401,   406,
     407,   408,   409,   410,   411,   412,   413,   414,   415,   416,
     417,   445,   446,   447,   448,   449,   463,   464,   465,   466,
     482,   483,   488,   489,   494,   495
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "STRING_TYPE", "VOID",
  "EQ", "NE", "LT", "GT", "LE", "GE", "IF", "UNLESS", "ELSE", "WHILE",
  "FOR", "PRINT", "READ", "RETURN", "BREAK", "CONTINUE", "AND_OP", "OR_OP",
  "NOT_OP", "BOOL_TYPE", "PIPE", "LBRACE", "RBRACE", "LPAREN", "RPAREN",
  "SEMICOLON", "ASSIGN", "','", "PLUS", "MINUS", "MULT", "DIV",
  "PLUS_ASSIGN", "MINUS_ASSIGN", "MULT_ASSIGN", "DIV_ASSIGN", "NUMBER",
  "FLOAT_NUMBER", "IDENTIFIER", "STRING_LITERAL", "TRUE_LITERAL",
  "FALSE_LITERAL", "UMINUS", "$accept", "program", "statement_list",
  "statement", "compound_statement", "type", "var_declaration_actual",
  "declarator_list_actual", "declarator_actual", "assignment",
  "io_statement", "control_statement", "for_init", "opt_expression",
  "function", "function_signature", "params_opt", "param", "param_list",
  "statements_opt", "term", "expression", "factor", "args_opt", "arg_list", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     285,   286,   287,   288,    44,   289,   290,   291,   292,   293,
...
#line 179 "parser.y"
    {
        ...
        (yyval.nodePtr) = createVarDeclarationNode(current_declaration_type_node, id_node_for_ast, nullptr, yylineno);
        if (!c_insert_variable((yyvsp[0].sval), current_declaration_type_node, yylineno, (yyval.nodePtr))) 
        {
...
#line 188 "parser.y"
    {
        ...
        (yyval.nodePtr) = createVarDeclarationNode(current_declaration_type_node, id_node_for_ast, (yyvsp[0].nodePtr), yylineno);
        if (!c_insert_variable((yyvsp[-2].sval), current_declaration_type_node, yylineno, (yyval.nodePtr))) 
        {
